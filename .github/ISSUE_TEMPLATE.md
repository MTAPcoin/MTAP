...
This issue tracker is only for technical issues related to MTAP Core.
General MTAP questions and/or support requests and are best directed to the [MTAP Discord](https://discordapp.com/invite/9nzt37V).
...
### What version of MTAP Core are you using?
