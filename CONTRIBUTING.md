Contributing to MTAP Core
==================================

The MTAP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MTAP Core project, and is not to be
confused with overall MTAP Network Protocol consensus changes.

Whether a pull request is merged into MTAP Core rests with the project merge
...
Patches that change MTAP consensus rules are considerably more involved than
...
Where a patch set proposes to change the MTAP consensus, it must have been
...
The project leader is the release manager for each MTAP Core release.
