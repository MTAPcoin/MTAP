...
RESOURCES += src/qt/mtap.qrc src/qt/mtap_locale.qrc

TRANSLATIONS += src/qt/locale/mtap_bg.ts \
                src/qt/locale/mtap_de.ts \
                src/qt/locale/mtap_en.ts \
                src/qt/locale/mtap_es.ts \
                src/qt/locale/mtap_fi.ts \
                src/qt/locale/mtap_fr.ts \
                src/qt/locale/mtap_it.ts \
                src/qt/locale/mtap_ja.ts \
                src/qt/locale/mtap_pl.ts \
                src/qt/locale/mtap_pt.ts \
                src/qt/locale/mtap_ru.ts \
                src/qt/locale/mtap_sk.ts \
                src/qt/locale/mtap_sv.ts \
                src/qt/locale/mtap_vi.ts \
                src/qt/locale/mtap_zh_CN.ts \
                src/qt/locale/mtap_zh_TW.ts
