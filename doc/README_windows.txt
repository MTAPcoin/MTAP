...
Intro
-----
MTAP (MTAP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. MTAP utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run mtap-qt.exe.

MTAP Core is the original MTAP client and it builds the backbone of the network.
However, it downloads and stores the entire history of MTAP transactions;
