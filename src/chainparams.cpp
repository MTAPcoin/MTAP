...
// Copyright (c) 2017 The MTAP developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000005b5991efaf2b450d9b51866f84d148249ad6e9949a718745daa67a9f8cf"));
	

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1551270851, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // MTAP: 2 minute blocks during POW (block 1-200)
        nMaturity = 5; // 6 block maturity (+1 elsewhere)
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 10000000 * COIN; // 10 million max supply
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for MTAP

        const char* pszTimestamp = "MTAP has moved to a new chain! - MTAP Dev Team 27/02/2019";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1551270851;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 24775258;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000005b5991efaf2b450d9b51866f84d148249ad6e9949a718745daa67a9f8cf"));
        assert(genesis.hashMerkleRoot == uint256("0x1af1d26a82f25dc86afd302a9bfdeb5e1ebf3e660a409ea067f532d9f08f1245"));

        // MTAP addresses start with 'M'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 50);
        // MTAP script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // MTAP private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // MTAP BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // MTAP BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // MTAP BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // MTAP: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet MTAP addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet MTAP script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet MTAP BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet MTAP BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet mtap BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // MTAP: 1 day
        nTargetSpacing = 2 * 60;        // MTAP: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
