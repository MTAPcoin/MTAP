...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MTAP features */
        {"mtap", "masternode", &masternode, true, true, false},
        {"mtap", "listmasternodes", &listmasternodes, true, true, false},
        {"mtap", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mtap", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mtap", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mtap", "masternodedebug", &masternodedebug, true, true, false},
        {"mtap", "startmasternode", &startmasternode, true, true, false},
        {"mtap", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mtap", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mtap", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mtap", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mtap", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mtap", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mtap", "mnbudget", &mnbudget, true, true, false},
        {"mtap", "preparebudget", &preparebudget, true, true, false},
        {"mtap", "submitbudget", &submitbudget, true, true, false},
        {"mtap", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mtap", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mtap", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mtap", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mtap", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mtap", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mtap", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mtap", "checkbudgets", &checkbudgets, true, true, false},
        {"mtap", "mnsync", &mnsync, true, true, false},
        {"mtap", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> mtap-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6934/\n";
}
