...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MTAP Core mtap-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mtap-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mtap transaction") + "\n" +
                               "  mtap-tx [options] -create [commands]   " + _("Create hex-encoded mtap transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mtap transaction
