...
// Copyright (c) 2017-2018 The MTAP Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MTAP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MTAP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mtap: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MTAP Core"), this);
    aboutAction->setStatusTip(tr("Show information about MTAP Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for MTAP Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MTAP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MTAP addresses"));
    ...
    openAction->setStatusTip(tr("Open a mtap: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MTAP Coin help message to get a list with possible MTAP Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/mtap_logo_horizontal").pixmap(210, 50));
    ...
    if (enableWallet) {
       ...
       if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        ...
        frameToolbar->setStyleSheet(".QFrame { margin-left:-0px; background-color: #1880af; }");
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MTAP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MTAP network", "", count));
}
...
{
    QString strTitle = tr("MTAP Core"); // default title
