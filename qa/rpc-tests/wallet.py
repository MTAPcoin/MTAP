...
#   c) node1 mines 32 blocks, so now node 0 has 500000MTAP, node 1 has 4250MTAP, node2 has none.
#   d) node0 sends 601 MTAP to node2, in two transactions (301 MTAP, then 300 MTAP).
